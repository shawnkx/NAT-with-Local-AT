...
def get_parser(desc, default_task='translation'):
    ...
    # fmt: off
    parser.add_argument('--delete-ratio', default=0.15, type=float,
                        help='delete ratio')
    parser.add_argument('--translation-output-file', default='translation.txt',
                        help='translation output file')
    parser.add_argument('--unmask-loss-ratio', type=float, default=0.1, metavar='N',
                        help='loss ratio for unmask word')
    parser.add_argument('--len-context', type=int, default=1, metavar='N',
                        help='len of context for decoder')
    parser.add_argument('--context-dir', default='both',
                        help='direction of context, both, right or left.')
...
def add_generation_args(parser):
    ...
    # --
    parser.add_argument("--record_stat", type=int, default=1)
    ...
    group.add_argument('--length-beam', default=1, type=int, metavar='N',
