...
class Trainer(object):
    ...
    def train_step(self, samples, dummy_batch=False, raise_oom=False):
        ...
        try:
            ...
            # macro change
            self.optimizer.multiply_grads(1. / float(len(samples)))
            # clip grads
            ...
            if 'nll_loss' in logging_output:
                ...
                self.meters['train_nll_loss'].update(logging_output.get('nll_loss', 0))
    ...
    def valid_step(self, sample, raise_oom=False):
        ...
        if 'nll_loss' in logging_output:
            ...
            self.meters['valid_nll_loss'].update(logging_output.get('nll_loss', 0))
