...
from fairseq.data import (
    ...
    IndexedRawTextDataset, IndexedCachedDataset, IndexedDataset, LanguagePairRNNContextMask
)

from . import FairseqTask, register_task


@register_task('translation_self_rnn_context')
class TranslationSelfRNNContextTask(FairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        ...
        assert src_dict.boseg() == tgt_dict.boseg()
    ...
    def load_dataset(self, split, combine=False, epoch=0):
        ...
        self.datasets[split] = LanguagePairRNNContextMask(
            ...
            unmask_loss_ratio=self.unmask_loss_ratio,
            del_ratio=self.args.delete_ratio
        )
