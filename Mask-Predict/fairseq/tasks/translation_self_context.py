...
from fairseq.data import (
    ...
    IndexedRawTextDataset, IndexedCachedDataset, IndexedDataset, LanguagePairContextMask
)

from . import FairseqTask, register_task


@register_task('translation_self_context')
class TranslationSelfContextTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, epoch=0):
        ...
        self.datasets[split] = LanguagePairContextMask(
